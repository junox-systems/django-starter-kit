...
// ParticleObject — vendored from Canvas UI (https://github.com/DavidHDev/canvas-ui)
// License: MIT + Commons Clause v1.0, Copyright (c) 2026 David Haz.
// Use in an application/website is permitted; selling or redistributing the
// component itself is not. Full text: https://github.com/DavidHDev/canvas-ui/blob/main/LICENSE.md
...
export function createParticleObject(
  ...
  async function loadAsset() {
    ...
    try {
      ...
      else console.error("[ParticleObject] failed to load asset:", error);
    }
  }
